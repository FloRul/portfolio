...
% Font selection - using more modern and professional fonts
\usepackage{bookman} % For main text - elegant serif font
\usepackage{helvet} % Helvetica for sans-serif elements
\usepackage{courier} % For monospaced content
\renewcommand{\familydefault}{\rmdefault} % Use serif as default font

% Define colors
\definecolor{primary}{RGB}{0, 90, 160}
\definecolor{darkgray}{RGB}{80, 80, 80}

% Configure sections to use sans-serif font
\titleformat{\section}
  {\sffamily\Large\bfseries\color{primary}}
  {}{0em}{}[\titlerule]
\titlespacing*{\section}{0pt}{12pt}{8pt}

% Configure subsections with sans-serif font
