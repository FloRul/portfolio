...
\usepackage{librebaskerville} % For main text - elegant serif font
\usepackage[defaultsans]{source} % Source Sans Pro for sans-serif elements
\usepackage{inconsolata} % For monospaced content
